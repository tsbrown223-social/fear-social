...
const DAILY_REEL_TEMPLATES = [
  ...
  },
  {
    ...
    feature: "Discover founders, creators, students, operators, and first-time builders who are also figuring it out.",
  ...
  {
    tag: "FEAR Pro",
    title: "Guided Mentorship Is Coming",
    feature: "The FEAR Pro mentor program will bring guided mentor discovery and focused introductions to members ready for their next move.",
    beats: ["Clarify the guidance you need.", "Prepare one focused question.", "Turn the answer into a next step."],
    cta: "Join early access and look for mentorship when FEAR Pro launches.",
  },
  {
    tag: "Prompts",
  ...
  },
  {
    ...
    feature: "fear.social DMs are there for warm intros, follow-ups, opportunity questions, and honest first outreach.",
