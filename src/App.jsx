...
function OpportunitiesView({deals,savedDeals,toggleSave,signalInterest,postOpportunity,profile}){
  ...
  const types=["All",...Array.from(new Set(["Job","Gig","Opportunity",...deals.map(deal=>deal.type).filter(Boolean)]))];
