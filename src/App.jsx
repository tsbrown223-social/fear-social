  ...
  return(
    <div className="app-view" style={{minHeight:"100vh",background:C.bg}}>
      ...
      <main id="app-main" className="app-shell" tabIndex={-1} style={{maxWidth:1320,margin:"0 auto",padding:"28px"}}>
        ...
        {view==="messages"&&<MessagesView messages={messages} setMessages={setMessages} sendMessage={sendMessage} deleteChat={deleteChat} activeConversationId={activeConversationId} onBlockUser={blockUser} onReport={reportContent} profileId={profile.id}/>}
...
function MessagesView({messages,setMessages,sendMessage,deleteChat,activeConversationId,onBlockUser,onReport,profileId}){
