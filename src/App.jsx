...
function MessagesView({messages,setMessages,sendMessage,activeConversationId}){
  const safeMessages=(Array.isArray(messages)?messages:[]).map(message=>({...message,thread:Array.isArray(message.thread)?message.thread:[],draft:message.draft||""}));
